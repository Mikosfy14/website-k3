    ...
    <aside class="bg-light sidebar d-flex flex-column p-3" style="width: 250px; height: 100vh; position: fixed; z-index: 1000;">
        ...
        <form method="POST" action="{{ route('logout') }}" class="mt-auto" id="logout-form">
            ...
            <button type="submit" class="btn btn-link nav-link text-danger w-100 text-start">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16" style="display: inline-block; vertical-align: text-bottom;">
