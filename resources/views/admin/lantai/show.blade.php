                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 pt-4 border-top">
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.lantai.edit', $lantai->id_lantai) }}" class="btn btn-warning fw-bold px-4">
                                Edit
                            </a>
                            <form action="{{ route('admin.lantai.destroy', $lantai->id_lantai) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger fw-bold px-4" onclick="return confirm('Yakin ingin menghapus lantai ini?')">
                                    Hapus
                                </button>
                            </form>
                        </div>
