                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 pt-4 border-top">
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.ruangan.edit', $ruangan->id_ruangan) }}" class="btn btn-warning">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="me-1" viewBox="0 0 16 16">
                            ...
                            <form action="{{ route('admin.ruangan.destroy', $ruangan->id_ruangan) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus ruangan ini?')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="me-1" viewBox="0 0 16 16">
