...
<a href="{{ route('admin.jalur-mitigasi.create') }}" class="btn btn-warning d-flex align-items-center justify-content-center py-2 px-4">
    <div class="fw-bold">Tambah Jalur Evakuasi</div>
</a>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.jalur-mitigasi.index') }}">
                        <div class="row g-3">
                            ...
                            <button type="submit" class="btn btn-warning d-flex align-items-center justify-content-center py-2 px-4 w-100">
